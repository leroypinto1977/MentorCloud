...
const Chatbot = () => {
  ...
  const questionFlow = [
    ...
    { 
      field: 'lastName', 
      question: 'Perfect! Now I\'ll need your email so we can keep you updated on your mentor matching journey. What\'s your email address?', 
      type: 'text' 
    },
    { 
      field: 'email', 
      question: 'Great! Just in case we need to reach you quickly, could you share your phone number too?', 
      type: 'text' 
    },
    { 
      field: 'phone', 
      question: 'Awesome! Now let me get a sense of where you\'re located. What\'s your postal code?', 
      type: 'text' 
    },
    { 
      field: 'postalCode', 
    ...
    { 
      field: 'city', 
      question: 'Perfect! Now let\'s talk about your professional life. What\'s your current job title?', 
      type: 'text' 
    },
    { 
      field: 'jobTitle', 
      question: 'Interesting! And which company or organization do you work with?', 
      type: 'text' 
    },
    { 
      field: 'company', 
      question: 'Wonderful! Here\'s where I\'d love to learn more about you. Could you tell me about your professional journey? I\'m curious about your line of work, what interests you most, your experience level, and what truly gets you excited in your field. Don\'t worry about making it perfect - just share what feels authentic to you!', 
      type: 'text' 
    },
    { 
      field: 'professionalSummary', 
      question: 'Thank you for sharing that with me! 🌟 Now, let\'s dive into something really important - your core values. These help me understand what kind of mentor relationship would feel right for you.\n\nI\'d love for you to pick up to 5 values that truly resonate with who you are. Just click on the ones that speak to you:', 
      type: 'multi-select',
      options: ['Accountability', 'Commitment', 'Compassion', 'Empathy', 'Family', 'Hard Work', 'Honesty', 'Humility', 'Integrity', 'Mutual Respect', 'Punctuality', 'Quality', 'Responsibility', 'Service', 'Teamwork', 'Truth', 'Win-Win'],
      maxSelections: 5
    },
    { 
      field: 'humanValues', 
      question: 'I love your choices! Those values really paint a picture of who you are. 🎯\n\nNow let\'s talk about your career aspirations. What areas would you like to focus on for your growth in the near term? Pick up to 5 that excite you most:', 
      type: 'multi-select',
      options: ['Building Mentorship Skills', 'Getting Promoted', 'Negotiating Compensation', 'Networking & Relationships', 'Personal Branding', 'Personal Development', 'Pivoting', 'Powerful Conversations', 'Presentation Skills', 'Thought Leadership'],
      maxSelections: 5
    },
    { 
      field: 'careerGrowthTopics', 
      question: 'Excellent selections! 🌈 I really appreciate that you\'re thinking about diversity, equity, and inclusion too. These topics are so important in today\'s world.\n\nWhich of these DEI areas would you like to explore with a mentor? Choose up to 5:', 
      type: 'multi-select',
      options: ['Awareness of Unconscious Bias', 'Encouraging Allyship', 'Having Empathy', 'Having Honest Conversations', 'Inclusive Leadership', 'Managing Diverse Teams', 'Recognizing & Addressing Microaggressions', 'Understanding DEI', 'Understanding Diverse Cultures'],
      maxSelections: 5
    },
    { 
      field: 'diversityEquityTopics', 
      question: 'Fantastic! 👨‍💼👩‍💼 Leadership is such a journey, isn\'t it? Whether you\'re already in a leadership role or aspiring to be, these skills are game-changers.\n\nWhich leadership areas would you most like to develop? Pick your top 5:', 
      type: 'multi-select',
      options: ['Attracting Talent', 'Communication', 'Conflict Management', 'DEI (Diversity, Equity & Inclusion)', 'Effective Team Management', 'Giving and Receiving Feedback', 'Innovation', 'Leading Virtual Teams', 'Managing Team Morale', 'Managing Upwards', 'Motivating Teams', 'Talent Management'],
      maxSelections: 5
    },
    { 
      field: 'leadershipTopics', 
      question: 'Perfect! 📋 Last but definitely not least - project management. Even if it\'s not your main role, these skills are incredibly valuable in almost any career.\n\nWhich project management areas would be most helpful for you? Choose your final 5:', 
      type: 'multi-select',
      options: ['Budgeting', 'Change Management & Communication', 'Customer & Stakeholder Management', 'Driving Change', 'Large-scale Programs', 'Managing Resource Constraints', 'Planning & Execution', 'Problem Solving', 'Scoping & Deadlines'],
      maxSelections: 5
    }
  ];

  // Options component for bubble selections
  const OptionBubbles = ({ options, selectedValues, onOptionSelect, onSubmit, maxSelections }) => {
    return (
  ...
  const handleOptionSubmit = (selections) => {
    ...
    setTimeout(() => {
      ...
      if (userStep < questionFlow.length - 1) {
        ...
        botResponse = nextQuestion.question.replace('{firstName}', userDetails.firstName);
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      ...
      if (userStep < questionFlow.length - 1) {
        const nextQuestion = questionFlow[userStep + 1];
        botResponse = nextQuestion.question.replace('{firstName}', userDetails.firstName || userInput);
        setUserStep(prev => prev + 1);
  ...
  const generateCompletionCard = () => {
    ...
    return `🎉 Wow, ${details.firstName}! Thank you so much for taking the time to share all of this with me. I feel like I really know you now, and I'm genuinely excited about finding you the perfect mentor match!
...
**What Drives You:**
💎 Core Values: ${details.humanValues.length > 0 ? details.humanValues.join(', ') : 'To be updated'}

**Your Growth Journey:**
🚀 Career Focus: ${details.careerGrowthTopics.length > 0 ? details.careerGrowthTopics.join(', ') : 'To be updated'}

🌈 DEI Interests: ${details.diversityEquityTopics.length > 0 ? details.diversityEquityTopics.join(', ') : 'To be updated'}

👨‍💼 Leadership Goals: ${details.leadershipTopics.length > 0 ? details.leadershipTopics.join(', ') : 'To be updated'}

📋 Project Management: ${details.projectManagementTopics.length > 0 ? details.projectManagementTopics.join(', ') : 'To be updated'}
